...
from news.views import NewsHome,NewsDetail
...
from tools.views import Validate
...
urlpatterns = [
    ...
    path('btc/address/', Validate.as_view(),name="validate_btc_address"),

    path('btc/', Home.as_view()),
    path('btc/detail/<int:pk>/', Detail.as_view(),name="btc_detail"),
    ...
    path('gositemap/', views.flatpage, {'url': '/gositemap/'}, name='gositemap'),
